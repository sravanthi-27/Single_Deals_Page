    ...
    <div className="w-full flex flex-col items-center">
      ...
      <div className="justify-between hidden lg:flex relative bg-white w-full max-w-[1280px] h-auto md:h-[530px] mt-[100px] overflow-visible ml-[150px] xl:ml-[50px] ">
        <div className="relative -left-[20px]">
          <div className="w-[432px] h-[432px] flex-shrink-0 rounded-[8.166px] border border-[#888] overflow-hidden relative mt-9">
            <div
        ...
        <div className="absolute top-5 -left-[90px] pl-[470px] md:pl-[550px] pr-6 h-full flex flex-col justify-start w-full mt-2">
          <h1 className="text-[#2D2D2D] font-montserrat uppercase font-bold text-[36px] xl:text-[48px] leading-[140%] text-left max-w-[783px]">
            Midweek Calm – ₹ 20% Off All Bookings
          </h1>

          <p className="text-[#2D2D2D] font-montserrat text-[14px] xl:text-[18px] font-normal mb-2 max-w-[700px] text-left">
            Take a mindful pause midweek. Book any session and enjoy 20%
            off—because calm shouldn't wait for the weekend.
          </p>

          <p className="font-montserrat font-normal text-[15px] xl:text-[19px] leading-[125%]">
            by{" "}
            <span className="font-montserrat font-normal underline decoration-solid underline-offset-2">
              INNERSTUDIO GLOW
            </span>
          </p>
          <br />
          <p className="text-[#2D2D2D] font-montserrat text-[14px] xl:text-[16px] font-normal underline underline-offset-2 mb-4 max-w-[700px] text-left -mt-2">
          ...
          <div className="flex items-center gap-2 mb-8 max-w-[700px]">
            ...
            <p className="text-[#464646] font-montserrat text-[16px] xl:text-[20px] font-medium leading-[110%]">
              Sector 45, Gurugram, Haryana 122018, India
            </p>
          </div>

          <button className="flex flex-row items-center justify-center bg-black text-white text-[16px] md:text-[18px] px-6 py-3 rounded-md hover:bg-gray-800 transition w-[180px] md:w-[200px] h-[50px] md:h-[60px]">
            GET THIS DEAL
            <img
      ...
      <div className="hidden md:flex lg:hidden flex-col items-center w-full mt-[100px] px-10">
        <div className="flex flex-col md:flex-row w-full items-start gap-8">
          ...
          <div className="flex-grow pt-3 ">
            <h1 className="text-[#2A2929] font-inter uppercase font-bold text-[24px] leading-tight mb-2">
              Midweek Calm – ₹ 20% Off All Bookings
            </h1>
            <p className="text-[#2D2D2D] font-montserrat text-base font-normal mb-2">
              Take a mindful pause midweek. Book any session and enjoy 20%
              off—because calm shouldn't wait for the weekend.
            </p>
            <p className="font-montserrat font-normal text-[15px] leading-[125%]">
              by{" "}
              <span className="font-montserrat font-normal underline decoration-solid underline-offset-2">
                INNERSTUDIO GLOW
              </span>
            </p>
            <p className="text-[#2D2D2D] font-montserrat text-[15px] font-normal underline underline-offset-2 my-2">
              Fitness & Body Movement / Yoga
            </p>
            <div className="flex items-start gap-1 mb-4">
              ...
              <p className="text-[#464646] font-montserrat text-lg">
                Sector 45, Gurugram, Haryana 122018, India
              </p>
            </div>
            <button className="flex flex-row items-center justify-center bg-black text-white text-[16px] md:text-[18px] px-6 py-4 rounded-md hover:bg-gray-800 transition w-[180px] md:w-[200px] h-[50px] md:h-[60px]">
              GET THIS DEAL
              <img
                className="w-[10px] md:w-[11px] h-[18px] md:h-[20px] ml-2 opacity-100"
                src={img}
      ...
      <div className="block md:hidden bg-white w-full mt-[70px]">
        ...
        <div className="px-4 pt-4 pb-8">
          <h1 className="text-[#2D2D2D] font-inter uppercase font-extrabold text-[20px] mb-3 leading-tight">
            Midweek Calm – ₹ 20% Off All Bookings
          </h1>
          <p className="text-[#2D2D2D] font-montserrat text-[14px] font-normal mb-3">
            Take a mindful pause midweek. Book any session and enjoy 20% off—because calm shouldn't wait for the weekend.
          </p>
          <p className="text-[#2D2D2D] font-montserrat text-[13px] font-normal underline underline-offset-2 mb-3">
            Fitness & Body Movement / Yoga
          </p>
          <p className="font-montserrat font-normal text-[14px] mb-4">
            by{" "}
            <span className="font-montserrat font-normal text-[14px] underline decoration-solid underline-offset-2">
              INNERSTUDIO GLOW
            </span>
          </p>
          <div className="flex items-start gap-2 mb-4">
            ...
            <p className="text-[#464646] font-montserrat text-[14px]">
              Sector 45, Gurugram, Haryana 122018, India
            </p>
          </div>
          <button className="flex flex-row items-center justify-center bg-black text-white text-[14px] px-5 py-2 rounded-md mb-6 w-full max-w-[200px]">
            GET THIS DEAL
            <img
